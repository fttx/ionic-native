...
import { Plugin, Cordova, IonicNativePlugin } from '@fttx/core';
 ...
 * @usage
 * ```typescript
 * import { UnviredCordovaSDK } from '@fttx/unvired-cordova-sdk/ngx';
 *
 *
...
@Plugin({
  ...
  install: 'ionic cordova plugin add @fttx/unvired-cordova-sdk', // OPTIONAL install command, in case the plugin requires variables
