...
import { Cordova, CordovaFunctionOverride, IonicNativePlugin, Plugin } from '@fttx/core';
 ...
 * ```typescript
 * import { ThreeDeeTouch, ThreeDeeTouchQuickAction, ThreeDeeTouchForceTouch } from '@fttx/three-dee-touch/ngx';
 *
