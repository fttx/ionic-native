...
import { CordovaInstance, InstanceCheck, IonicNativePlugin, Plugin, checkAvailability } from '@fttx/core';
 ...
 * @usage
 * ```typescript
 * import { FileTransfer, FileUploadOptions, FileTransferObject } from '@fttx/file-transfer/ngx';
 * import { File } from '@fttx/file';
 *
