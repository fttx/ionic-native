...
import { Plugin, Cordova, CordovaProperty, CordovaInstance, InstanceProperty, IonicNativePlugin } from '@fttx/core';
 ...
 * @usage
 * ```typescript
 * import { AllInOneSDK } from '@fttx/all-in-one-sdk/ngx';
 *
 *
