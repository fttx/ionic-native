...
import { CordovaCheck, CordovaInstance, getPromise, IonicNativePlugin, Plugin } from '@fttx/core';
 ...
 *
 * ```typescript
 * import { SecureStorageEcho, SecureStorageEchoObject } from '@fttx/secure-storage-echo/ngx';
 *
