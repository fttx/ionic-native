...
import { CordovaCheck, CordovaInstance, IonicNativePlugin, Plugin, getPromise } from '@fttx/core';
 ...
 *
 * ```typescript
 * import { SecureStorage, SecureStorageObject } from '@fttx/secure-storage/ngx';
 *
