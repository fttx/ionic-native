 ...
 * @usage
 * ```typescript
 * import { OpenALPR, OpenALPROptions, OpenALPRResult } from '@fttx/openalpr/ngx';
 *
 *
 ...
 * }
 *
 * // To get imageData, you can use the @fttx/camera module for example. It works with DestinationType.FILE_URI and DATA_URL
 *
