...
import { Cordova, CordovaProperty, IonicNativePlugin, Plugin } from '@fttx/core';
 ...
 * @usage
 * ```typescript
 * import { MediaCapture, MediaFile, CaptureError, CaptureImageOptions } from '@fttx/media-capture/ngx';
 *
 *
