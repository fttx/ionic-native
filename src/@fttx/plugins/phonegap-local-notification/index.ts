...
import { Cordova, CordovaInstance, IonicNativePlugin, Plugin, checkAvailability } from '@fttx/core';
 ...
 * @usage
 * ```
 * import { PhonegapLocalNotification } from '@fttx/phonegap-local-notification/ngx';
 *
 *
