...
import { CordovaInstance, InstanceCheck, IonicNativePlugin, Plugin } from '@fttx/core';
 ...
 * @usage
 * ```typescript
 * import { ThemeableBrowser, ThemeableBrowserOptions, ThemeableBrowserObject } from '@fttx/themeable-browser/ngx';
 *
