...
import { CordovaInstance, InstanceProperty, IonicNativePlugin, Plugin, checkAvailability } from '@fttx/core';
 ...
 * @usage
 * ```typescript
 * import { MSAdal, AuthenticationContext, AuthenticationResult } from '@fttx/ms-adal/ngx';
 *
 *
