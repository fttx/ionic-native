...
import { CordovaInstance, IonicNativePlugin, Plugin, checkAvailability } from '@fttx/core';
 ...
 * @usage
 * ```typescript
 * import { FlurryAnalytics, FlurryAnalyticsObject, FlurryAnalyticsOptions } from '@fttx/flurry-analytics/ngx';
 *
